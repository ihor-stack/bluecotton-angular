...
export class ElementFactory {
  static fromJson(json: object, area: Area, colorsService: ColorsService, imagesService: ImagesService): Element {
    ...
    switch (elementType) {
      ...
      case 'ImageUploadElement':
        element = ImageUploadElement.newFromJson(json, area, json['data'].image, imagesService);
        break;
