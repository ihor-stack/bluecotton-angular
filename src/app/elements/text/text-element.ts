...
export class TextElement extends Element {
  ...
  public duplicate(): Element {
    ...
    newElement.textPaths = null;
    newElement.textPathsContainer = null;
    newElement.shapeType = null;
  ...
  get icon(): string {
    return '<i class="las la-font menu-icon"></i>';
  }
  ...
  private convertTextToImage(): Observable<string> {
    ...
    if (this.shapeName === 'arch') {
      this.svgElement.width(220).height(54);
      this.imageElement
            .width(220)
            .height(54)
          ;
