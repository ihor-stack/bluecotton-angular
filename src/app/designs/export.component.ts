...
@Component({
  ...
  template: `
    <div class="btn-row">
      <button type="button" class="justify-btn-left btn btn-sm btn-secondary" (click)="onExport()">Export</button>
      <button type="button" class="justify-btn-right btn btn-sm btn-secondary" (click)="onProof()">Proof</button>
    </div>
